...
function ext_set_is_AI_mode_enabled(enable_AI_mode) {
    if (enable_AI_mode) {
        $('.enable-AI-mode-button').html('Turn off smart mode')
    } else {

        $('.enable-AI-mode-button').html('Activate smart mode')
    }
}
    ...
    swal(
        {
            ...
            text: 'The number of floors is a number between 2-50 (inclusive)\n\nNote: If you use the browser zoom function, please adjust it back to 100% and set it again for normal use!',
            type: 'input',
        ...
        function (inputValue) {
            ...
            if (inputValue === '') {
                swal.showInputError('the content can not be blank!');
                return false;
            }
            var re = /^\+?[1-9][0-9]*$/s;
            ...
            if (value < 2 || value > 50) {
                swal.showInputError(
                    'The number of floors must be in the range 2-50. The value you enter is' + value +
                    '!')
                return false;
            }
            ...
            swal(
                'Nice!',
                'Your floor number has been changed to:' + value + ', a new elevator system has been generated!',
                'success',
            )
        });
}
    ...
    swal(
        {
            ...
            closeOnConfirm: false,
            animation: 'slide-from-top',
            inputPlaceholder: 'Enter your desired number of elevators here...'
        },
        function (inputValue) {
            if (inputValue === false) {
                return false;
            ...
            if (inputValue === '') {
                swal.showInputError('Content cannot be empty!');
                return false;
            }
            var re = /^\+?[1-9][0-9]*$/;
            if (!re.test(inputValue)) {
            ...
            if (value < 1 || value > 30) {
                swal.showInputError(
                    'The number of elevators must be in the range of 1-30. The value you enter is' + value +
                    '!')
                return false;
            }
            ...
            swal(
                'Nice!',
                'Your floor elevator number has been changed to:' + value + ', a new elevator system has been generated!',
                'success',
            )
        });
}
